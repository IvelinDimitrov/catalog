...
export function About() {
  ...
  return (
    <>
      ...
      <section
        id="hero"
        className="bg-navi py-16 flex flex-col lg:flex-row items-center justify-center px-8"
      >
        {/* Text Content */}
      ...
      Our History 
          ...
          <p className="mb-10 text-gray-txt lg:w-4/5">
          Welcome to Wood Heaven. Our story began as a small, family-owned workshop driven by a passion for fine woodworking. Over the years, our dedication to exceptional craftsmanship and quality has transformed us into a leading name in luxury furniture. We blend traditional techniques with modern design to create timeless, handcrafted pieces that embody our commitment to both artistry and sustainability. At Wood Heaven, every item reflects our journey from humble beginnings to a distinguished brand, designed to elevate your living space with elegance and sophistication.
          </p>
          
        </div>
      </section>
      <section id="features" className="bg-background-color text-green-tx">
            ...
            <div className="grid gap-8 sm:grid-cols-2 md:gap-12 xl:grid-cols-3 xl:gap-16">
              ...
              <div className="flex gap-4 md:gap-6">
                ...
                <div>
                  ...
                  <Link
                    to='/'
                    className="font-bold text-gray-dark transition duration-100 hover:text-[#827552] active:text-primary"
                  >
                    Learn More
                  </Link>
                </div>
